...
5. **Only create truly custom components when no suitable registry primitive or block exists**, and only after consulting `frontend-design` skill for design-quality output.
...
- **Custom UI / bespoke styling**: invoke the `frontend-design` skill. Do not hand-roll without it.
